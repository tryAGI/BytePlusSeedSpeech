...
{
    /// <inheritdoc />
    public sealed class AudioFormatJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::BytePlusSeedSpeech.AudioFormat>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::BytePlusSeedSpeech.AudioFormatExtensions.ToValueString(value));
        }
    }
}
